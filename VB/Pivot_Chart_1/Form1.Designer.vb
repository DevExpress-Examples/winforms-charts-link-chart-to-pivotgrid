...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.chartControl1.CustomizeXAxisLabels += new DevExpress.XtraCharts.CustomizeXAxisLabelsEventHandler(this.chartControl1_CustomizeXAxisLabels);
			' 
			' Form1
			' 
