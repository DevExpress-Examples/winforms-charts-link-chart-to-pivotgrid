...
Namespace Pivot_Chart
    Partial Public Class Form1
        ...
        Private Sub chartControl1_CustomizeXAxisLabels(ByVal sender As Object, ByVal e As CustomizeXAxisLabelsEventArgs) Handles chartControl1.PivotChartingCustomizeXAxisLabels
            e.Staggered = False
        End Sub
