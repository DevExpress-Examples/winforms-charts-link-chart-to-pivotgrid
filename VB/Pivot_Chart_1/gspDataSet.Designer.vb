...
Namespace Pivot_Chart_1
	...
	End Class
End Namespace
Namespace Pivot_Chart_1.gspDataSetTableAdapters
		...
		Public Overridable Function UpdateAll(ByVal dataSet As gspDataSet) As Integer
			...
			Try
				...
				If (Me._gSPTableAdapter IsNot Nothing) Then
					...
					Me._gSPTableAdapter.Connection = (CType(workConnection, Global.System.Data.OleDb.OleDbConnection))
					Me._gSPTableAdapter.Transaction = (CType(workTransaction, Global.System.Data.OleDb.OleDbTransaction))
			...
			Finally
				...
				End If
				If (Me._gSPTableAdapter IsNot Nothing) Then
					Me._gSPTableAdapter.Connection = (CType(revertConnections(Me._gSPTableAdapter), Global.System.Data.OleDb.OleDbConnection))
