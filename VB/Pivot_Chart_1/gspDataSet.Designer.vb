...
Namespace Pivot_Chart
    ...
    Partial Public Class gspDataSet
        ...
        Public Overrides Function Clone() As Global.System.Data.DataSet
            Dim cln As gspDataSet = (DirectCast(MyBase.Clone(), gspDataSet))
            cln.InitVars()
        ...
        Partial Public Class GSPDataTable
            ...
            Default Public ReadOnly Property Item(ByVal index As Integer) As GSPRow
                Get
                    Return (DirectCast(Me.Rows(index), GSPRow))
                End Get
            End Property
            ...
            Public Function AddGSPRow(ByVal Region As String, ByVal Year As Integer, ByVal GSP As Double) As GSPRow
                Dim rowGSPRow As GSPRow = (DirectCast(Me.NewRow(), GSPRow))
            ...
            Public Function FindByID(ByVal ID As Integer) As GSPRow
                Return (DirectCast(Me.Rows.Find(New Object() { ID}), GSPRow))
            End Function

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Overrides Function Clone() As Global.System.Data.DataTable
                Dim cln As GSPDataTable = (DirectCast(MyBase.Clone(), GSPDataTable))
                cln.InitVars()
                Return cln
            End Function
            ...
            Public Function NewGSPRow() As GSPRow
                Return (DirectCast(Me.NewRow(), GSPRow))
            End Function
            ...
            Protected Overrides Sub OnRowChanged(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                ...
                RaiseEvent GSPRowChanged(Me, New GSPRowChangeEvent((DirectCast(e.Row, GSPRow)), e.Action))
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Protected Overrides Sub OnRowChanging(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                MyBase.OnRowChanging(e)
                RaiseEvent GSPRowChanging(Me, New GSPRowChangeEvent((DirectCast(e.Row, GSPRow)), e.Action))
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Protected Overrides Sub OnRowDeleted(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                MyBase.OnRowDeleted(e)
                RaiseEvent GSPRowDeleted(Me, New GSPRowChangeEvent((DirectCast(e.Row, GSPRow)), e.Action))
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Protected Overrides Sub OnRowDeleting(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                MyBase.OnRowDeleting(e)
                RaiseEvent GSPRowDeleting(Me, New GSPRowChangeEvent((DirectCast(e.Row, GSPRow)), e.Action))
            End Sub
        ...
        Partial Public Class GSPRow
            ...
            Public Property ID() As Integer
                Get
                    Return (DirectCast(Me(Me.tableGSP.IDColumn), Integer))
                End Get
            ...
            Public Property Region() As String
                Get
                    Try
                        Return (DirectCast(Me(Me.tableGSP.RegionColumn), String))
            ...
            Public Property Year() As Integer
                Get
                    Try
                        Return (DirectCast(Me(Me.tableGSP.YearColumn), Integer))
                    Catch e As Global.System.InvalidCastException
            ...
            Public Property GSP() As Double
                Get
                    Try
                        Return (DirectCast(Me(Me.tableGSP.GSPColumn), Double))
                    Catch e As Global.System.InvalidCastException
...
Namespace Pivot_Chart.gspDataSetTableAdapters
    ...
    Partial Public Class TableAdapterManager
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Private Function UpdateUpdatedRows(ByVal dataSet As gspDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Me._gSPTableAdapter IsNot Nothing) Then
                Dim updatedRows() As Global.System.Data.DataRow = dataSet.GSP.Select(Nothing, Nothing, Global.System.Data.DataViewRowState.ModifiedCurrent)
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Private Function UpdateInsertedRows(ByVal dataSet As gspDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Me._gSPTableAdapter IsNot Nothing) Then
                Dim addedRows() As Global.System.Data.DataRow = dataSet.GSP.Select(Nothing, Nothing, Global.System.Data.DataViewRowState.Added)
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Private Function UpdateDeletedRows(ByVal dataSet As gspDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Me._gSPTableAdapter IsNot Nothing) Then
                Dim deletedRows() As Global.System.Data.DataRow = dataSet.GSP.Select(Nothing, Nothing, Global.System.Data.DataViewRowState.Deleted)
        ...
        Public Overridable Function UpdateAll(ByVal dataSet As gspDataSet) As Integer
            ...
            Try
                ...
                If (Me._gSPTableAdapter IsNot Nothing) Then
                    ...
                    Me._gSPTableAdapter.Connection = (DirectCast(workConnection, Global.System.Data.OleDb.OleDbConnection))
                    Me._gSPTableAdapter.Transaction = (DirectCast(workTransaction, Global.System.Data.OleDb.OleDbTransaction))
            ...
            Finally
                ...
                End If
                If (Me._gSPTableAdapter IsNot Nothing) Then
                    Me._gSPTableAdapter.Connection = (DirectCast(revertConnections(Me._gSPTableAdapter), Global.System.Data.OleDb.OleDbConnection))
